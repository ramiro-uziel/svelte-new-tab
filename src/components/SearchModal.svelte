...
<div transition:fade={{ duration: 30 }}>
	<div
		class="bg-black bg-opacity-60 w-screen h-screen fixed flex justify-center items-center font-Bitter"
		bind:this={parent}
	>
		<div
			class="rounded-md relative bg-transparent w-[500px] h-[580px]"
				...
				<div class="flex flex-col">
					<div class="flex flex-row items-center">
						<input
							...
							autofocus
						/>
						<i class=" mr-3 fa-solid fa-search text-md text-zinc-600"></i>
					</div>
