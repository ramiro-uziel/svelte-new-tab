...
>
	{#each items as item}
		<li class="mb-[-1px]">
			...
			<span
				class={`block p-2 px-4 w-auto cursor-pointer select-none border rounded-lg duration-75 active:scale-[97%]  ${activeTabValue === item.value ? 'text-[#fdf6e3] border-[#a7a7a7] bg-[#44444438] ' : 'border-transparent hover:text-light-blue hover:border-[#444444] '}`}
